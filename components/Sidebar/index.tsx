...
const Sidebar = () => {
  ...
  return (
    ...
    >
      ...
      >
        <MotionStack variants={stagger} spacing={5} w="100">
          <div>
            <MotionText
              variants={fadeInUp}
              delay={1}
          ...
          <div>
            ...
            <MotionText
              ...
              variants={fadeInUp}
            >
              Or you could call me Vishu. That works too . . .
            </MotionText>
          </div>
          <MotionHeading
            as="h3"
          ...
          >
            ...
            end integration, recently found myself studying DevOPS too.
          </MotionText>
          <MotionButton
            size="lg"
            variant="outline"
          ...
          <MotionBox className={"flex"} d="flex" variants={simpleOpacity} >
