  ...
  return (
    ...
    >
      ...
      <Text variant="description">
        I am always open to new opportunities and collaborations. Whether its about coding, work, movies, Im ready to engage and contribute. Feel free to connect with me on any of my social media platforms or send me an email. Im looking forward to hearing from you!{' '}
        <Link
